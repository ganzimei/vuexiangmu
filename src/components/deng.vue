  ...
  <div class="deng">
    ...
    <div class="dengq">
      ...
      <div class="check">
        ...
        <div class="read">
          我已阅读并同意<span>服务协议</span>和<span>隐私服务</span>
        </div>
      </div>
      <div class="butt">
        <van-button type="primary" size="large" color="#ccc" @click="denglu()"
          >立即登录</van-button
        >
      </div>
      <div class="other">
      ...
      <div class="im"><img src="../../public/images/3.png" class="img" /></div>
